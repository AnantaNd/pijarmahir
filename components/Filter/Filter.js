  ...
  return (
    <>
      <div className={styles.container}>
        ...
        {/* <select onChange={onCategory} className={styles.filter}>
          <option value="">Pilih kategori</option>
          <option value="Kartu Prakerja">Kartu Prakerja</option>
          <option value="Mahir Digital">Mahir Digital</option>
          <option value="Mahir Teknologi">Mahir Teknologi</option>
        </select> */}
        <div onChange={onCategory} className={styles.filter}>
